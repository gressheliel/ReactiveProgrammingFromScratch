...
public class Lec03HotPublisherAutoConnect {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        var movieFlux = movieStream()
                .publish()
                .autoConnect(2); // Hot Publisher, Sam and Mike will see the movie from the moment they join
                                              // If we put 0, the movie starts immediately, no wait any person
                                              // If we put N, the movie starts when the N person join
                                              // If they exit, the movie continue

        Util.sleepSeconds(2);
        movieFlux
                .take(4)  // Sam will see only 4 scenes
